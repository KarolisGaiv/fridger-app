...
export async function up(db: Kysely<any>) {
  await db.schema
    ...
    .addColumn("mealId", "integer", (c) => c.notNull().references("meal.id").onDelete("cascade"))
    .addColumn("ingredientId", "integer", (c) => c.notNull().references("ingredient.id").onDelete("cascade"))
